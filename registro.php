  ...
  <section class="contenedor seccion">
    ...
    <form action="validar_registro.php" id="registro" class="registro" method="POST">
        <div id="datos_usuario" class="registro caja clearfix">
            ...
            <div class="campo"><!--es recomendable separar el apellido en su propio campo-->
                <label for="apellido">Apellido:</label>
                <input type="text" id="apellido" name="apellido" placeholder="Tu apellido">
            </div>
            <div class="campo"><!--tamaño-->
              ...
              <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                      ...
                      <input type="number" name = "boletos[]" min="0" id="pase_dosdia" size="3" placeholder="0">
                    </div>
                  </div><!--.tabla-precio-->
                </li>
          </ul><!--.lista-precios-->
      ...
      <div id="resumen" class="resumen clearfix">
        ...
        <div class="caja clearfix">
          <div class="extras">
            <div class="orden">
              <label for="camisa_evento">Camisa del evento 10COP <small>(promocion 7% de descuento)</small> </label>
              <input type="number" name="pedido_camisa" id="camisa_evento" placeholder="0" min="0" size="">
            </div><!--.orden-->
            <div class="orden">
              <label for="etiquetas">Paquete de etiquetas 3COP <small>(HTML5 CSS3 JavaScript, Chrome)</small> </label>
              <input type="number" name="pedido_etiqueta" id="etiquetas" placeholder="0" min="0" size="">
            </div><!--.orden-->
            <div class="orden">
          ...
          <div class="total">
            ...
            <input type="hidden" name = "total_pedido" id = "total_pedido"><!--campo oculto para enviar el valor total del pedido-->
            <input type="submit" name = "submit" value="Pagar" id="btnRegistro" class="boton">
          </div>
        </div><!--.caja-->
      </div>
